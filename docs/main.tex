...
Tangential research challenges are plentiful.
% TODO: sentence
We are excited to see how the presence of types in graph databases will benefit people who work with data by enhancing query performance, aiding query specification, and bridging the gap between the programming language and the database.
