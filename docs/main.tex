...
An example of a property graph is given in \autoref{fig:pg}. Nodes and edges are drawn as rectangles and arrows, respectively. Each object is associated with a set of labels and properties. Node labels are written in the top compartment, and node properties are written in the bottom compartment. Edge labels are drawn inside pills, and edge properties are surrounded by `\{' and `\}', which are omitted when an edge has no properties.
