...
% TODO: We discuss threats to validity...

\paragraph{Internal validity.} This concerns the degree of confidence in the causal relationship between the dependent and independent variables in our study.
% Instrumentation: time measuring. only affects difference between databases, which is huge anyway (or is this concept validity?)

\paragraph{Construct validity.}
% ?

\paragraph{External validity.} This concerns the generalization of our results.
% Scale to larger data/schema?
% If no additional experiment:
% - Effect of schema with fixed scale
% - Exact cardinality constraints
% Different kinds of schema violations
