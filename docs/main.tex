...
An example of a property graph type is given in \autoref{fig:pg-type-example}.

\begin{figure}[t]
  \centering
  \includegraphics[width=\textwidth]{figures/pg-type-example.pdf}
  \caption{A property graph type, visualized as a property graph. This is a fragment of the LDBC SNB schema \cite{angles2020snb}.}
  \label{fig:pg-type-example}
\end{figure}
...
TODO: property graph type with cardinality constraints
