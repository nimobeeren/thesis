...
\begin{definition}[Property graph type]
  ...
  \begin{itemize}
    ...
    \item $\gamma : (N \times E) \pto \{n..m \mid n \in \N, m \in \N^*\}$ is a partial function mapping some pairs of schema nodes and schema edges to cardinality constraints, where $\N$ is defined as $\{0, 1, 2, \ldots\}$ and $\N^*$ is defined as $\N \cup \{*\}$;
  \end{itemize}
