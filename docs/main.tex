...
\begin{table}[t]
  ...
  \begin{tabular}{lcccccc}
    \hline
     & \textbf{\citeauthor{angles2018property}} & \textbf{\citeauthor{pokorny2017integrity}}$^\dagger$ & \textbf{\citeauthor{bonifati2019schema}} & \textbf{\citeauthor{lbath2021inference}}$^\ddagger$ & \textbf{\citeauthor{lei2021thesis}} & \textbf{Ours} \\
    \hline
    ...
    \hline
  \end{tabular}
  \caption[Comparison of capabilities of property graph schema formalisms found in the literature and ours]{Comparison of capabilities of property graph schema formalisms found in the literature and ours as detailed in \autoref{ch:pg-schema}. $*$: only one-to-one, one-to-many, etc. \textdagger: only informal specification. {\footnotesize \textdaggerdbl}: no specification of conformance.}
...
% TODO: move table to the end
% TODO: refer to implementation, not formalism
...
\begin{table}[t]
  ...
  \begin{tabular}{lccccc}
    ...
    \hline
  \end{tabular}
  \caption[Comparison of schema capabilities of current property graph databases and our implementation]{Comparison of schema capabilities of current property graph databases and our implementation as detailed in \autoref{ch:practice}. $*$: only one-to-one, one-to-many, etc.}
...
In \autoref{ch:related-work}, we compared the capabilities of existing property graph schema implementations. We can now see how all but one of the features in \autoref{tab:pg-schema-databases} can be mapped to one of our conformance rules.
