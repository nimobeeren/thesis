...
Schemas for graph data have been discussed extensively in the literature. \citet{buneman1997adding} proposes a method that represents both data and schema as edge-labeled graphs. This allows the specification of the types of edges which are allowed in a database, but does not cover mandatory edges or more general edge cardinality constraints.
