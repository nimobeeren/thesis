...
We see ample opportunity for performance improvements, either through specialized validation algorithms, indexes, or query optimization. We have already observed sub-second validation times on datasets of millions of objects, which encourages us to believe that schema validation will be possible on an interactive time scale, especially when incremental algorithms are employed.

% TODO: research opportunities
We are excited to see how the presence of types in graph databases will benefit people who work with data by enhancing query performance, aiding query specification, and
% TODO: type safety?
