...
\begin{figure}[t]
  ...
  \caption{Schema of the SNB dataset. This schema was created by modifying the schema from \citet{angles2020snb} to not rely on subtype relations, as described in \autoref{sec:schema-discussion}.}
