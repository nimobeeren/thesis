...
\begin{table}[H]
  ...
  \begin{tabular}{|l|l|r|r|r|}
    \hline
    \textbf{Dataset}                & \textbf{Variant} & \textbf{Neo4j} & \textbf{JanusGraph} & \textbf{TigerGraph} \\
    \hline
    \multirow{2}{*}{Recomendations} & Boolean          & 663            & TODO                & TODO                \\
    \cline{2-5}                     & Full             & 7,494          & 5,808               & 67                  \\
    \hline
    \multirow{2}{*}{SNB (SF0.1)}    & Boolean          & 6,680          & TODO                & TODO                \\
    \cline{2-5}                     & Full             & 27,876         & TODO                & TODO                \\
    \hline
    \multirow{2}{*}{SNB (SF0.3)}    & Boolean          & TODO           & TODO                & TODO                \\
    \cline{2-5}                     & Full             & TODO           & TODO                & TODO                \\
    \hline
    \multirow{2}{*}{SNB (SF1)}      & Boolean          & TODO           & TODO                & TODO                \\
    \cline{2-5}                     & Full             & TODO           & TODO                & TODO                \\
    \hline
  \end{tabular}
  \caption{Total execution time of validation queries in milliseconds.}
  \label{tbl:results}
\end{table}

% How are different databases affected by variant? (3 grouped bar charts)
...
% How are different databases affected by different schemas? (3 bar charts)
% - databases: all (separate charts)
% - datasets: all (bars)
% - scales: 0.1
% - variant: full
