...
\begin{enumerate}[label=\bfseries RQ\arabic*,ref=RQ\arabic*]
  ...
  \item\label{rq:violations} How is validation time affected by the amount of schema violations?
...
\begin{itemize}
  ...
  \item \emph{Many:} 50\% of all nodes violate a constraint.
\end{itemize}
