...
\paragraph{Keywords:} graph databases, property graphs, data modeling, graph schemas, schema specification, schema validation
...
\begin{itemize}
  ...
  \item In nearly all scenarios, TigerGraph is much faster than Neo4j, and Neo4j is much faster than JanusGraph. However, when the data does not conform to the schema, JanusGraph's performance drastically improves, even matching TigerGraph. 
