...
We start by introducing our data model, which is based on the concept of a \emph{property graph} as established by the Working Group for Database Languages~(WG3), which is a part of ISO/IEC JTC1/SC32~\cite{deutsch2021gpml}. We use this data model in the rest of this document.
...
After the original specification, the ER model has been extended in various ways. For example, a notation which introduced cardinality constraints, optionality, and subtype relations was developed by \cite{barker1990entity}.
