...
% TODO: rename property graph type to schema?
...
An example of a property graph type is given in \autoref{fig:pg-type}.

\begin{figure}[t]
  \centering
  \includegraphics{figures/pg-type.pdf}
  \caption{A property graph type.}
  \label{fig:pg-type}
\end{figure}
...
\begin{figure}[t]
  ...
  \caption{Property graphs that do not conform to the property graph type of \autoref{fig:pg-type}. Violating nodes and edges have a red dotted outline.}
...
An example of a property graph type with cardinality constraints is given in \autoref{fig:pg-type-card}. Note that this is a relaxed version of \autoref{fig:pg-type}.

\begin{figure}[t]
  \centering
  \includegraphics{figures/pg-type-card.pdf}
  \caption{A property graph type with cardinality constraints.}
  \label{fig:pg-type-card}
\end{figure}
...
Compared to Definition \ref{def:pg-type}, rules \ref{rule:conformance-card-node} and \ref{rule:conformance-card-edge} have not changed, but \ref{rule:conformance-card-out} and \ref{rule:conformance-card-in} now ensure that there not too few or too many edges of a certain type.
...
\begin{figure}[t]
  ...
  \caption{Property graphs validated against the property graph type of \autoref{fig:pg-type-card}. Violating nodes and edges have a red dotted outline.}
