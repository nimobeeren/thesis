...
\begin{table}[t]
  ...
  \begin{tabular}{llrrrr}
    ...
    \hline
  \end{tabular}
  \caption{Mean validation time for binary and full variants on all datasets with no errors. A two-sided T-test is used to test for a difference between the mean validation time for the full and binary variant. Significant results (p $< 0.05$) are marked with *.}
