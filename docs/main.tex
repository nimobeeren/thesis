...
\begin{enumerate}[label=\bfseries RQ\arabic*]
  % \item How is validation time affected by the types of constraints in the schema?
...
% TODO: general description of methodology and describe what's coming next
...
\paragraph{Hardware.} All tests are run on a single machine with 4 CPU cores, 6 gigabytes of dedicated memory, and a solid-state drive with enough capacity to store all data.
